...
| -------- | ---- | -------- | ------------- | ----------- |
|`search`| [text](../../G1ANT.Language/Structures/TextStructure.md) | yes |  | Tab searching phrase |
|`by`| [text](../../G1ANT.Language/Structures/TextStructure.md) | yes|  | Tab searching constraint: `title` or `url` |
