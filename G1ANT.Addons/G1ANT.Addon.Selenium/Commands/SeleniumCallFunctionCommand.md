...
| -------- | ---- | -------- | ------------- | ----------- |
|`functionname`| [text](../../G1ANT.Language/Structures/TextStructure.md) | yes |  | Name of a function to call |
|`parameters`| [text](../../G1ANT.Language/Structures/TextStructure.md) | no |  | Parameters to be passed to the function |
|`type`| [text](../../G1ANT.Language/Structures/TextStructure.md) | yes |  | Function call type: `javascript` or `jquery` |
