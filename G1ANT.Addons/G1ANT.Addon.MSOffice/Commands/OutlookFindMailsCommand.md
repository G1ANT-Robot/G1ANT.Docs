...
| -------- | ---- | -------- | ------------- | ----------- |
|`search`| [text](](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md)) | yes | | Word to be searched for in a message subject |
|`showmail`| [bool](](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/BooleanStructure.md)) | no | false | If set to `true`, G1ANT.Robot will show all emails meeting the criteria |
