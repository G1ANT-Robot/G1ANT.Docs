...
In the following script a new message with two attachments (be sure to provide real filepaths there) is created. To send it, use the [`outlook.send`](../G1ANT.Addon.MSOffice/Commands/OutlookSendCommand.md) command.
