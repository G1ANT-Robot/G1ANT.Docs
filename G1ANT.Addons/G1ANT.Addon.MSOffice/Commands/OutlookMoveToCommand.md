...
| ------------------- | ------------------------------------------------------------ | -------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| `item`              | [outlookmail](../G1ANT.Addon.MSOffice/Structures/OutlookMailStructure.md) or [outlookfolder](../G1ANT.Addon.MSOffice/Structures/OutlookFolderStructure.md) | yes      |                                                              | An item (a message or a folder) to be moved                  |
| `destinationfolder` | [outlookfolder](../G1ANT.Addon.MSOffice/Structures/OutlookFolderStructure.md) | yes      |                                                              | Destination Outlook folder                                   |
