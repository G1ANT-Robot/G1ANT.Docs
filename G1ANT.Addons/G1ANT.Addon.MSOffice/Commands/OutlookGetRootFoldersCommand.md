...
| -------------- | ------------------------------------------------------------ | -------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| `result`       | [variable](../../G1ANT.Language/Structures/VariableStructure.md) | no       | `♥result`                                                    | Name of a variable where the command's result will be stored. The variable will be of [list](../../G1ANT.Language/Structures/ListStructure.md) structure containing elements of [outlookfolder](../G1ANT.Addon.MSOffice/Structures/OutlookFolderStructure.md) structure |
