...
| -------- | ---- | -------- | ------------- | ----------- |
|`path`| [text](](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md)) | no | current folder and filename                                  |Specifies path, where the current Word document will be saved. If a filename is not specified and the document has never been saved, the default name is used (for example, `Doc1.docx`)|
