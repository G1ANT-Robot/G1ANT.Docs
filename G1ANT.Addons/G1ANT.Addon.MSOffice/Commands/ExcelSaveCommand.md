...
| -------- | ---- | -------- | ------------- | ----------- |
|`path`| [text](../../G1ANT.Language/Structures/TextStructure.md) | no |  | Full path to a file to be saved. If not specified, G1ANT.Robot will try to save the file using the path it was loaded from. If the current Excel instance was opened with no path specified, error handling will be applied |
