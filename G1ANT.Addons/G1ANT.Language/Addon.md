...
| [text.read](https://github.com/G1ANT-Robot/G1ANT.Language/blob/master/G1ANT.Language/Commands/TextReadCommand.md) | This command reads text from a document and assigns it to a variable. |
...
| Name | Description |
| ---- | ----------- |
| [Watch](https://github.com/G1ANT-Robot/G1ANT.Language/blob/master/G1ANT.Language/Panels/WatchPanel.md) | Allows to watch variables and expressions in debug mode. |
...
| [mail](https://github.com/G1ANT-Robot/G1ANT.Language/blob/master/G1ANT.Language/Structures/MailStructure.md) |  |
...
| [keydelay](https://github.com/G1ANT-Robot/G1ANT.Language/blob/master/G1ANT.Language/Variables/KeyDelayVariable.md) | Determines the time (in ms) between the execution of consecutive keyboard commands; the default value is 10 |
| [locale](https://github.com/G1ANT-Robot/G1ANT.Language/blob/master/G1ANT.Language/Variables/LocaleVariable.md) | Determines information about culture (locale). |
...
| [mousedelay](https://github.com/G1ANT-Robot/G1ANT.Language/blob/master/G1ANT.Language/Variables/MouseDelayVariable.md) | Determines the time (in ms) between the consecutive mouse clicks generated by the mouse.click command; the default value is 10 |
...
| [timeoutchrome](https://github.com/G1ANT-Robot/G1ANT.Language/blob/master/G1ANT.Language/Variables/TimeoutChromeVariable.md) | Determines the timeout value (in ms) for the chrome command; the default value is 10000 |
...
| [timeoutprogram](https://github.com/G1ANT-Robot/G1ANT.Language/blob/master/G1ANT.Language/Variables/TimeoutProgramVariable.md) | Determines the timeout value for the program and shell commands; the default value is 5000 ms. |
