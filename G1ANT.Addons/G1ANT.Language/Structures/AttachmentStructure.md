...
## Example
This example shows how to download an attachment using the [`mail.imap`](../../G1ANT.Addon.Net/G1ANT.Addon.Net/Commands/MailImapCommand.md) command and save it on the desktop:
