...
```G1ANT
sap.sendcommand command ⟦text⟧
```

## Description
This command sends a SAP command over current SAP session (ie. /n, /i, /o, /h, /nex).
...
| ---------------- | ----------------------------------------------------------------- | -------- | --------------- | ------------------------------------------------------------ |
| `command`          | [text](/G1ANT.Addons/G1ANT.Language/Structures/TextStructure.md)       | no       |                | Command to execute. |
