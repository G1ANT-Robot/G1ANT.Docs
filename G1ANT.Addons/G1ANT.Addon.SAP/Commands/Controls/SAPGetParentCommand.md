...
```G1ANT
sap.getparent component ⟦sapcomponent⟧
```

## Description
Get parent of `component`. All components have parent except `/app`.

## Arguments

| Argument         | Type                                                              | Required | Default Value   | Description                                                  |
| ---------------- | ----------------------------------------------------------------- | -------- | --------------- | ------------------------------------------------------------ |
| `component`    | [sapcomponent](../../../Structures/SapComponentStructure.md)       | **yes**  |                | The component that is a child. Every component except `/app` is a child and has a parent. This parameter must contain `⟦sapcomponent⟧` or `⟦text⟧` with path. |
