...
| `result`        | [variable](../../G1ANT.Language/Structures/VariableStructure.md)  | no       | `♥result`     | Name of a variable where the command's result will be stored ([integer](../../G1ANT.Language/Structures/IntegerStructure.md) with number of rows). |
