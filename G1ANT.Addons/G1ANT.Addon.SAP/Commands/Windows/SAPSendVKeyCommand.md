...
| ---------------- | ----------------------------------------------------------------- | -------- | --------------- | ------------------------------------------------------------ |
| `vkey`          | [integer](../../G1ANT.Language/Structures/IntegerStructure.md)    | **yes**  |                | The virtual key `VKey` to be executed on the window. The `VKeys` are defined in the menu painter (i.e. 0 for `Enter`). |
