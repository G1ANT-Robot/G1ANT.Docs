...
|`pages`| [list](](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/ListStructure.md)) | no |                                                              | List of numbers of pages to be processed separated with [array separator](https://github.com/G1ANT-Robot/G1ANT.Manual/blob/develop/appendices/special-characters/array-separator.md) (❚), e.g. `1❚5❚6` |
