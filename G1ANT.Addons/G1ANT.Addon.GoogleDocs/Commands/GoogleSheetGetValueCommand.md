...
| -------- | ---- | -------- | ------------- | ----------- |
|`range`| [text](../../G1ANT.Language/Structures/TextStructure.md) | yes |  | Cell or range to get a value from, for example `A6`, `A3&B7` or `A3:A6&B7` |
|`sheetname`| [text](../../G1ANT.Language/Structures/TextStructure.md) | no | | Sheet name containing the specified range; can be empty or omitted |
