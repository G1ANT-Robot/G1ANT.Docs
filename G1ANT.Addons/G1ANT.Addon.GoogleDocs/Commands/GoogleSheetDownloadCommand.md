...
| -------- | ---- | -------- | ------------- | ----------- |
|`path`| [text](../../G1ANT.Language/Structures/TextStructure.md) | yes |  | Destination on your computer where the file will be saved |
|`type`| [text](../../G1ANT.Language/Structures/TextStructure.md) | no | xlsx | Type of the downloaded file (extension): `pdf` or `xlsx` |
