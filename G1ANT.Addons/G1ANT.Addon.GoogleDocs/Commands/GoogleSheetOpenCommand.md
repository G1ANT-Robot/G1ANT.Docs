...
When the document is opened, the robot assigns its own ID to this Google Sheets instance and you can use it later to close this particular instance with the [`googlesheet.close`](../G1ANT.Addon.GoogleDocs/Commands/GoogleSheetCloseCommand.md) command or switch to it with the [`googlesheet.switch`](../G1ANT.Addon.GoogleDocs/Commands/GoogleSheetSwitchCommand.md) command.
