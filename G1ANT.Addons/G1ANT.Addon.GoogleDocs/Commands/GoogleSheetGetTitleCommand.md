...
This command gets the title of an opened Google Sheets instance.
...
In the following script, the robot opens a Google Sheets document, gets its title and then displays it in a dialog box:
