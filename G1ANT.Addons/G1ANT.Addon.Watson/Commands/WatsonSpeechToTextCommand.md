...
| -------- | ---- | -------- | ------------- | ----------- |
|`path`| [text](../../G1ANT.Language/Structures/TextStructure.md) | yes |  | Path to a file with recorded speech |
...
|`language`| [text](../../G1ANT.Language/Structures/TextStructure.md) | no | en-US | Language of speech |
