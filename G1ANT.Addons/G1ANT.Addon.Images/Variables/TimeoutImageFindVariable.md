...
Determines the timeout value (in ms) for the [image.find](../Commands/ImageFindCommand.md) and [waifor.image](../Commands/WaitforImageCommand.md) commands; the default value is 20000 (20 seconds).
