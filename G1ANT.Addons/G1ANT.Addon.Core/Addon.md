...
| [timeoutwaitforcolor](https://github.com/G1ANT-Robot/G1ANT.Addon.Core/blob/master/G1ANT.Addon.Core/Variables/TimeoutWaitForColorVariable.md) | Determines the timeout value for the waitfor.color command; the default value is 10000. |
