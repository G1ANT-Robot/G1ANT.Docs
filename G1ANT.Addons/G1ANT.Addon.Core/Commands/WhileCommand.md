...
| -------- | ---- | -------- | ------------- | ----------- |
|`condition`| [bool](../../G1ANT.Language/Structures/BooleanStructure.md) | yes |  | A loop will be executed as long as the condition expressed in a C# snippet returns true |
