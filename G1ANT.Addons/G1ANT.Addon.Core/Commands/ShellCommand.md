...
| -------- | ---- | -------- | ------------- | ----------- |
|`command`| [text](../../G1ANT.Language/Structures/TextStructure.md) | yes |  | Command line instructions to be executed |
...
| `timeout`      | [timespan](../../G1ANT.Language/Structures/TimeSpanStructure.md) | no       | [♥timeoutprogram](../Variables/TimeoutProgramVariable.md) | Specifies time in milliseconds for G1ANT.Robot to wait for the command to be executed |
