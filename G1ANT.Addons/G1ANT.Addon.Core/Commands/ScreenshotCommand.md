...
| -------- | ---- | -------- | ------------- | ----------- |
|`path`| [text](../../G1ANT.Language/Structures/TextStructure.md) | no| [My] Documents\G1ANT.Robot | Specifies the path for a screenshot file, or, when only a filename is provided, the default path is added |
| `result`       | [variable](../../G1ANT.Language/Structures/VariableStructure.md) | no       | `♥result`                                                   | Name of a variable where the screenshot filename with a full path will be stored |
