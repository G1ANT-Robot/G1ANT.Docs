...
| -------- | ---- | -------- | ------------- | ----------- |
|`message`| [text](../../G1ANT.Language/Structures/TextStructure.md) | no |  | Allows to personalize the message displayed in a dialog box |
| `result`       | [variable](../../G1ANT.Language/Structures/VariableStructure.md) | no       | `♥result`                                                   | Name of a variable where the provided text will be stored |
