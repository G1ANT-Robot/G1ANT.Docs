...
![Sample mailing list CSV file in Notepad](https://raw.githubusercontent.com/G1ANT-Robot/G1ANT.Manual/raw/develop/G1ANT.Manual/-assets/mailing-list.jpg)
...
OK, you got your unread emails retrieved from the inbox. But where are they exactly? Yes, in a variable you specified. What you should know is that this variable is not ordinary, because it’s designed to store many items (messages) and each of them has typical email components such as from/to email addresses, message subject, message body or date received. We say that this is a [list](../../G1ANT.Addons/G1ANT.Language/Structures/ListStructure.md) variable (contains more than one element) and each of its elements is of [mail](../../G1ANT.Addons/G1ANT.Language/Structures/MailStructure.md) structure.
