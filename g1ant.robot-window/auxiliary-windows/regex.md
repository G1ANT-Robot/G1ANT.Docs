...
For more information on regex, please refer to a [Wikipedia entry](https://en.wikipedia.org/wiki/Regular_expression) and the [Regex Appendix](https://github.com/G1ANT-Robot/G1ANT.Manual/blob/develop/appendices/regex.md) to this manual.
